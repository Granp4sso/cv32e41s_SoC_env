...
module axi_ascon_uint32ToByteArray_clone (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [3:0] add_ln8_fu_112_p2;
wire   [3:0] add_ln9_fu_137_p2;
wire   [3:0] add_ln10_fu_147_p2;
reg   [1:0] ap_NS_fsm;
...
assign add_ln10_fu_147_p2 = (idx + 4'd3);

assign add_ln8_fu_112_p2 = (idx + 4'd1);

assign add_ln9_fu_137_p2 = (idx + 4'd2);
...
endmodule //axi_ascon_uint32ToByteArray_clone
