...
void VuCup_top_cv32e41s_pmp__P0_PB10_X1_XB0::_ctor_var_reset() {
    VL_DEBUG_IF(VL_DBG_MSGF("+                    VuCup_top_cv32e41s_pmp__P0_PB10_X1_XB0::_ctor_var_reset\n"); );
    // Body
    clk = VL_RAND_RESET_I(1);
    rst_n = VL_RAND_RESET_I(1);
    VL_RAND_RESET_W(4775, csr_pmp_i);
