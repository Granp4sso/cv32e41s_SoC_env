...
void VuCup_top_cv32e41s_pmp__P0_PB10::_ctor_var_reset() {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  VuCup_top_cv32e41s_pmp__P0_PB10::_ctor_var_reset\n"); );
    // Body
    ...
    __PVT__pmr_reloc_addr_o = VL_RAND_RESET_Q(34);
    ...
    __PVT__reloc_address = VL_RAND_RESET_Q(34);
